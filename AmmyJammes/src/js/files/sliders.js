...
function initSliders() {
	...
	// if (document.querySelector('.publications-slider')) { // Указываем скласс нужного слайдера
	// 	// Создаем слайдер
	// 	new Swiper('.publications-slider', { // Указываем скласс нужного слайдера
	// 		// Подключаем модули слайдера
	// 		// для конкретного случая
	// 		wrapperClass:'publications-slider__body',
	// 		slideClass:'publications-slider__slide',
	// 		modules: [Navigation],
	// 		observer: true,
	// 		observeParents: true,
	// 		slidesPerView: 1,
