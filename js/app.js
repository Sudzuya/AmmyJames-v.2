(() => {
    ...
    function initSliders() {
        if (document.querySelector(".other-books-slider")) new core(".other-books-slider", {
    ...
    contactNavigate.addEventListener("click", (function(e) {
        ...
        if (contactNavigate.classList.contains("open")) document.querySelector(".contact-navigation__close").addEventListener("click", (function() {
